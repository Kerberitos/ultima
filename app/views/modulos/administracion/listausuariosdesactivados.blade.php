	    	...
	    	<table class="table">
		        ...
		        <tbody>
			        ...
			        <tr class="fila-tabla-miradita">
			            <td>
			            	<a href="{{route('admin.verusuariodesactivado', [$cuenta->usuario->id])}}">
			            		{{ $i++ }}
			            	</a>
			            </td>
			            ...
			            <td> 
			            	<a href="{{route('admin.verusuariodesactivado', [$cuenta->usuario->id])}}" title="Ver usuario" class="btn btn-success btn-xs" > 
