          ...
          La cuenta de {{$usuario->nombres}} fue bloqueada porque 
            ...
            @if($usuario->historial)
                ...
                @if($usuario->historial->anunciosbloqueados >= $configuracion->anunciosbloqueados )
                    modificó {{$usuario->historial->anunciosbloqueados}} de sus anuncios ya publicados con contenido que infringe las política de uso.
                ...
                @elseif($usuario->historial->comentarioseliminados >= $configuracion->comentariosbloqueados)
                    realizó {{$usuario->historial->comentarioseliminados}} comentarios con contenido que incumple alguna política de uso.
    ...
    <div class="col-xs-12">
          <div class="row">
              ...
              @if($usuario->cuenta->estado->estado=="bloqueado")
                <a href="" data-toggle="modal" data-target="#modalcorreoautomatizado"  class="btn col-xs-12 col-sm-offset-5 col-sm-2 btn-warning btn-sm  espacio-superior-min" title="Enviar correo automatizado">
...
@include('modales.modalcorreoautomatizado')
@stop