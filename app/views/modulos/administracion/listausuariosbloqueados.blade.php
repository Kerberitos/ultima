    	...
    	@if (Session::has('status_error'))
   		...
   		@endif
	    	...
	    	@if (sizeof($cuentas)==0)
				...
				@else
					<div class="col-xs-12">
		      			<p class="alert alert-info alert-size">No hay usuarios bloqueados</p>
		    		</div>
		   		@endif
	  		@else
	  		<div class="col-xs-12">
			...
			<div>
				<form action="{{route('admin.usuarios.bloqueados')}}" method="GET" role="form">
				<div class="col-xs-12">
				 	<a href="{{route('admin.usuarios.bloqueados')}}" class="btn btn-success btn-sm btn-recargar pull-right" title="Recargar todos"><span class="icon-repeat" > </span> </a>
	    	...
	    	<table class="table">
		        ...
		        <tbody>
			        ...
			        <tr class="fila-tabla-miradita">
			            <td>
			            	<a href="{{route('admin.verusuariobloqueado', [$cuenta->usuario->id])}}">
			            		{{ $i++ }}
			            	</a>
			            </td>
			            ...
			            <td> 
			            	<a href="{{route('admin.verusuariobloqueado', [$cuenta->usuario->id])}}" title="Ver usuario" class="btn btn-success btn-xs" > 
