<div class="modal fade bs-example-modal-sm" id="denunciarrespuesta" tabindex="-1" role="dialog" aria-labelledby="denunciarrespuesta" aria-hidden="true">
        ...
        <div class="modal-body">
         ...
         <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                             <p class="informacion-adicional">Puede escribir aún <span id="max-length-denunciarespuesta">100</span> caracteres.</p>
                            <textarea style="resize:vertical;" class="form-control" placeholder="Detalle el motivo de la denuncia, mínimo 10 caracteres y máximo 100" rows="3" name="justificacion" maxlength='101' id='descripcion-denunciarespuesta' data-validation="required length" data-validation-length="min10" data-validation-error-msg-required="Ingrese el motivo de su denuncia, mínimo 10 caracteres"
            ...
            <div>
                <p>¿Desea denunciar a un administrador esta respuesta?</p>
              
            </div>
        </div>
        
        <div class="modal-footer ">
            <a href="" type="button" class="btn btn-danger btndenunciarespuesta">
                <span class="glyphicon glyphicon-circle-arrow-up"></span> 
                  Denunciar
            </a>
...
@section('scripts13')
    ...
    <script>
         $('#descripcion-denunciarespuesta').restrictLength( $('#max-length-denunciarespuesta') );
    </script>
@stop